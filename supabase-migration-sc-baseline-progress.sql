-- Strength & Conditioning Baseline and Progress Tracking Schema
...
-- Create RLS policies for sc_user_profiles
...
-- Create RLS policies for sc_baseline_tests
...
-- Create RLS policies for sc_progress_tracking
...
-- Create RLS policies for sc_program_enrollment
...
-- Create RLS policies for sc_data_consent
...
-- Create RLS policies for sc_hr_zones
...
-- Create trigger for sc_user_profiles
