...
const CleanSliderTest = () => {
  const [currentTime, setCurrentTime] = useState(0)
  const animationDuration = 20

  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      <h1 className="text-2xl font-bold mb-6">Clean Slider Test</h1>
      
      {/* Timeline slider - exact same as working components */}
...
export default CleanSliderTest
