-- Run this script in your Supabase SQL Editor to create the session_squads table
-- Copy and paste the entire contents of supabase-migration-session-squads.sql here
