-- Fix save_session_planning function - SIMPLE VERSION
-- This creates a basic version without complex role checking

-- 1. Drop the existing function
DROP FUNCTION IF EXISTS save_session_planning(UUID, JSON, JSON);

-- 2. Create a simple version that just saves the data
