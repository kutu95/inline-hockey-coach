-- Quick fix for session planner save functionality
...
-- Update the save_session_planning function to return TRUE on success
...
-- Also update the RLS policies to be more permissive for testing
